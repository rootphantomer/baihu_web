...
export default {
  ...
  about: {
    ...
    subtitle: 'About',
    statement:
      '杭州白鹄动画成立于杭州，核心成员来自日本各大动画公司，深谙日式动画的制作标准与文化语境。我们相信，只有对动画本身保持热爱，才能交付真正有生命力的作品。',
    mission: {
      label: '使命',
      text: '以专业技艺，为每一位合作伙伴的 IP 注入值得被看见的视觉力量。',
    },
    values: {
      label: '核心优势',
      quality: {
        title: '品质至上',
        desc: '严格遵循日本动画制作基准，每一帧均经过多轮品质管控。',
      },
      culture: {
        title: '文化理解',
        desc: '核心成员均有日本动画公司工作经验，深刻理解日式审美的细微之处。',
      },
      scale: {
        title: '灵活规模',
        desc: '可承接从单集到季度番组的各规模项目，快速响应工期需求。',
      },
    },
    history: {
      label: '发展历程',
    ...
    faq: {
      ...
      items: [
        {
          q: '白鹄动画提供哪些服务？',
          a: '白鹄动画专注于日式二维动画制作，提供动画、原画、背景美术、美术设定、作画监督等全流程服务。',
        },
        {
          q: '团队成员来自哪些公司？',
          a: '核心成员来自 Sunrise、MAPPA、J.C.STAFF 等日本顶级动画公司，深谙日式动画制作标准与文化语境。',
        },
        {
          q: '可以承接哪些类型的项目？',
          a: '可承接动画电影（TV/剧场版）、剧集动画、游戏PV、宣传片等多种类型的动画制作项目。',
        },
        {
          q: '在哪里可以看到白鹄动画的作品？',
          a: '您可以在作品页面查看白鹄动画参与制作的作品列表，涵盖高达、水星的魔女等多个知名日本动画项目。',
        },
      ],
    },
    clients: {
  ...
  join: {
    ...
    subtitle: 'Join Us',
    intro:
      '白鹄动画正在寻找对动画抱有热忱的你。我们提供有竞争力的薪酬、国际化的协作环境，以及接触一线日本动画项目的机会。',
    positions: {
      animator: {
        title: '原画师（第一原画）',
        location: '杭州',
  ...
  contact: {
    title: '联系我们',
    subtitle: 'Contact',
    intro: '如您有动画制作需求，或希望了解合作方式，欢迎通过以下渠道联系我们。',
    email: {
      label: '邮箱',
    ...
    address: {
      label: '地址',
      value: '浙江省杭州市滨江区长河街道齐飞路 350 号 圆伦大厦 A 座 1901',
    },
    social: {
      label: '社交媒体',
      weibo: '微博',
    ...
    hours: {
      label: '营业时间',
      value: '周一至周五 10:00 – 19:00（JST / CST）',
    },
  },
  news: {
    title: '新闻动态',
  ...
  server: {
    services: {
      title: '我们的服务',
      desc: '专注于二次元/游戏/影视动画领域的深耕，致力于打造高质感并富有感染力的动画作品，以及宣传影像，并参与制作各大游戏厂商的动画 PV 的制作。 公司团队由来自日升，草薙，MAPPA，JC_STAFF 的资深动画从业者组成，提供开放创新的创作环境与国际化协作资源。',
    },
    animation: {
      title: '动画制作服务',
